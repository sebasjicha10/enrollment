...
<h2>Description</h2>
This project consists of a simple enrollment page for courses given by my local university (UCR). <a href="https://youtu.be/N4fIXs1261c" target="_blank">Watch a video demo here</a>.<small>(Clicking on the link will redirect you to YouTube).</small>
<h2>Back End</h2>
<ul>
  <li>Python - Flask</li>
  <li>SQLite</li>
